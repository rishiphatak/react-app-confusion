...
class Header extends Component {
    ...
    handleLogin(event) {
        this.toggleModal();
        alert("Username: " + this.username.value + " PW: " + 
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We take inspiration from the World's best cuisines and cretae lipsmaking creations that will tickle your tastebuds.</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
